...
- **[`04_analisis_vocabulario_modelo_GPT2_fine_tuned.ipynb`](notebooks/04_analisis_vocabulario_modelo_GPT2_fine_tuned.ipynb)** → Análisis mediante TF-IDF y UMAP del dataset y las generaciones.
