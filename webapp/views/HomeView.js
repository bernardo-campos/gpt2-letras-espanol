export default {
    template: `
        <div>
            ...
            <footer class="text-center text-gray-500 text-sm max-w-4xl mx-auto">
                <p>
                    Los recursos mostrados en esta web, forman parte del proyecto de final de carrera titulado 'LA INTELIGENCIA ARTIFICIAL APLICADA A LA GENERACIÓN AUTOMÁTICA DE LETRAS DE CANCIONES' de la Universidad Católica de Santiago del Estero.
                    El repositorio completo, junto a otros recursos se encuentran en este enlace:
